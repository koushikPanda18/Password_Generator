...
// const copyButtton=document.querySelector(".copyBtn");
// const Slider=document.querySelector(".slider");
// const sliderLength=document.querySelector(".lenghtNumber");
...
const lengthDisplay = document.querySelector(".lenghtNumber");
